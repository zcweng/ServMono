package resteasy.test;


import java.util.Hashtable;

import resteasy.plugins.server.embedded.SecurityDomain;
import resteasy.plugins.server.sun.http.SunHttpJaxrsServer;
import resteasy.spi.ResteasyDeployment;
